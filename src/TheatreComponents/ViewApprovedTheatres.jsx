...
const ViewApprovedTheatres = () => {
  ...
  useEffect(() => {
    const getTheatres = async () => {
      const res = await retrieveTheatre();
      if (res) {
  ...
  const deleteTheatre = (theatreId, e) => {
    fetch("http://localhost:8080/api/theatre/delete?theatreId=" + theatreId, {
      method: "DELETE",
      headers: {
